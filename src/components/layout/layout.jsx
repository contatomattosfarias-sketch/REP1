...
import { LayoutDashboard, Wallet, Kanban, Settings, X, LogOut } from 'lucide-react';
...
export function Sidebar({ isOpen, onClose, isMobile }) {
  ...
  // Simulando cor do tema (futuramente vem do Contexto de Tema)
  ...
  const navItems = [
    ...
    { label: 'Kanban Jurídico', icon: Kanban, path: '/kanban' },
